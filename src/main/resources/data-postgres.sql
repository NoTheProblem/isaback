...
insert into examination(date,duration_minutes,is_free,price,dermatologist_id,pharmacy_id,loyalty_score) values ('2021-06-07 08:00:00',30,true,400,2,1,0);
insert into examination(date,duration_minutes,is_free,price,dermatologist_id,pharmacy_id,loyalty_score) values ('2021-06-07 10:00:00',30,true,400,2,1,0);
